...
class PosixInputService(InputService):
...
class PosixDpiService(DpiService):
    def set_process_dpi_awareness(self):
        # Linux/macOS normalmente delegan DPI al toolkit gráfico.
        return None


class PosixScreenService(ScreenService):
